...
7. "for(int I = 0; I < 10; I++) { ..."
   ...
   Konstrukcja pêtli FOR:
     ...
     Parametr 1 (p1): Zawiera deklaracjê zmiennej liczbowej ca³kowitej "I"
                      z przypisan¹ wartoœci¹ 0(tj. int I = 0;).
                      Zmienna liczbowa ca³kowita "I" i jej zawartoœæ
                      jest widoczna tylko w obrêbie pêtli FOR.
...
8. "cout << "\n" << I;"
   ...
   8.1. Przeniesienie kursora tekstowego do nastêpnego wiersza.
   8.2. Wyœwietlenie zawartoœci zmiennej liczbowej ca³kowitej "I".
9. Przeniesienie kursora tekstowego do kolejnych dwóch wierszy.
*/