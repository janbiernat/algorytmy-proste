...
using namespace std; 
/*--== CSV to table - w3 - Zapisz do pliku tekstowego ==-- 
...
int csv_do_tabeli::NadluzszyCiagZnakow(string Str = "") { 
  //NadluzszyCiagZnakow. 
...
int main(int argc, char *argv[]) { 
  cout << "--== CSV to table - w3 - Zapisz do pliku tekstowego ==--\n"; 
  ...
  //Znajdź najdłuższy ciąg znaków. 
    ...
    if(PlikDane != NULL) { 
      ...
      while(getline(PlikDane, Linia)) { 
        Ile = do_tabeli.NadluzszyCiagZnakow(Linia+';'); 
