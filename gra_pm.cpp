...
/*--== Gra w Państwa, Miasta: Ściąga ==--
  ...
  1. Bazy z danymi muszą być umieszczone w plikach tekstowych.
     W tym samych katalogu co plik "gra_pm.exe".
  2. Każda kategoria posiada pliki tekstowe, dla poszczególnych liter alfabetu.
     Na przykład: kategoria MIASTA.
                  ...
                  od litery B. Dla pozostałych liter tworzymy kolejne pliki
                  tekstowe.
     Tak samo robimy dla pozostałych kategorii.
  3. Nazwa pliku z danymi składa się z trzech elementów:
     ...
     3.2. Nazwy pobranej z pliku konfiguracyjnego (tj. "gra_pm.cfg").
          Nazwa pliku tekstowego znajduje się za znakiem średnika (tj. ;).
     3.3. Rozszerzenia trzyliterowego ".txt".
*/
using namespace std;
