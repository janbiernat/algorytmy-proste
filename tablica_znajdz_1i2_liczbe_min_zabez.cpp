...
#include <conio.h>
using namespace std;
/*--== Znajdź 1 i 2 liczbę minimalną - Zabezpieczenie ==--
...
*/
int main() {
  cout << "--== Znajdz 1 i 2 liczbe minimalna - Zabezpieczenie ==--\n";
  cout << "Copyright (c)by Jan T. Biernat\n\n";
  //Deklaracja stałych.
    const short Ile = 6;
  //Deklaracja zmiennych.
    short Licznik = 0, Tak = 0;
  ...
  //ale mniejszą od pozostałych liczb.
    ...
    cout << "\nKolejna min. liczba to: ";
    if(Tak == 1) { cout << Tablica[Licznik]; }
    else { cout << "Wszystkie podane liczby sa takie same!"; }
  cout << "\n\n";
}