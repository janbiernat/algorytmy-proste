...
using namespace std;
/*
--== Iloœæ ocen na procenty ==--
Zadanie: Napisz program, który obliczy sumê
         iloœci poszczególnych ocen
         oraz procentowy udzia³
         iloœci poszczególnych ocen.
*/
double DwieLiczbyPo(double Liczba) {
  return(int(Liczba*100)/100.0);
}
//
//Blok g³ówny.
int main() {
  cout << "--== Ilosc ocen na procenty ==-- \n";
  ...
  //Raport.
    ...
    for(int I = 0; I < 6; I++) {
      ...
      Procent = 0; Procent = DwieLiczbyPo((Dane[I]*100.0)/Suma);
      cout << Procent << "%)\n";
