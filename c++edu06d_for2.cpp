...
using namespace std;
/*
--== [c++edu06d_for2] Pêtla FOR: Wyœwietlenie liczb naturalnych ==--
...
*/
int main() {
  cout << "[c++edu06d_for2] Petla FOR: Wyswietlenie liczb naturalnych \n";
...
Wiersz 27: for(int I = 1; I < Z; I++) { ...
           ...
           Konstrukcja pêtli FOR:
             ...
             Parametr 2 (p2): Zawiera warunek (tj. I <= Z) okreœlaj¹cy, ile razy
...
Wiersz 28: if(I > 1) { cout << ", "; }
           Za pomoc¹ instrukcji warunkowej IF nastêpuje sprawdzenie,
           czy zmienna I jest wiêksza od cyfry 1 (tj. I > 1).
...
Wiersz 29: cout << ((Z+1)-I);
           Wyœwietl na ekranie zawartoœæ wyniku wynikaj¹ca z odjêcia od liczby przechowywanej
           w zmiennej liczbowej "Z" powiêkszonej o wartoœæ 1, zawartoœci zmiennej liczbowej "I".
Wiersz 31: cout << ".";
