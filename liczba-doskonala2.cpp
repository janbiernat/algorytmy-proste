...
using namespace std; 
/*--== Liczba doskonała 2 - Wyświetlenie dzielników ==-- 
...
int main() { 
  cout << "--== Liczba doskonala 2 - Wyswietlenie dzielnikow ==--\n"; 
  cout << "Copyright (c)by Jan T. Biernat\n\n"; 
  //Deklaracja zmiennych liczbowych. 
    long int Liczba = 0, Wynik = 0; 
  //Pobierz dane z klawiatury. 
    cout << "Liczba: "; cin >> Liczba; 
  //Wywołanie funkcji "LiczbaDoskonala". 
    Wynik = LiczbaDoskonala(Liczba); 
    cout << " = " << Liczba << " <-- jest liczba "; 
    if(Wynik > 0) { cout << "doskonala."; } 
    else { cout << "naturalna."; } 
